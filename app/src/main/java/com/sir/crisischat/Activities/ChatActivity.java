...
import com.sir.crisischat.Adapters.ChatAdapter;
import com.sir.crisischat.Models.ChatMessage;
import com.sir.crisischat.Models.Users;
import com.sir.crisischat.Network.ApiClient;
import com.sir.crisischat.Network.ApiService;
import com.sir.crisischat.Utilities.Constants;
import com.sir.crisischat.Utilities.PreferenceManager;
import com.sir.crisischat.databinding.ActivityChatBinding;
...
public class ChatActivity extends BaseActivity {
    ...
    private void sendMessage(){
        ...
        if (conversationId != null){
            updateConversation(activityChatBinding.inputMessage.getText().toString());
        }
        else{
            HashMap<String, Object> conversation = new HashMap<>();
            conversation.put(Constants.KEY_SENDER_ID, preferenceManager.getString(Constants.KEY_USERID));
            conversation.put(Constants.KEY_SENDER_NAME, preferenceManager.getString(Constants.KEY_NAME));
            conversation.put(Constants.KEY_SENDER_IMAGE, preferenceManager.getString(Constants.KEY_IMAGE));
            conversation.put(Constants.KEY_RECEIVER_ID, receiverUser.id);
            conversation.put(Constants.KEY_RECEIVER_NAME, receiverUser.name);
            conversation.put(Constants.KEY_RECEIVER_IMAGE, receiverUser.image);
            conversation.put(Constants.KEY_LAST_MESSAGE, activityChatBinding.inputMessage.getText().toString());
        ...
        if(!isReceiverAvailable){
            try {
                ...
                data.put(Constants.KEY_USER, preferenceManager.getString(Constants.KEY_USERID));
    ...
    private void setListeners(){
        ...
        activityChatBinding.layoutSend.setOnClickListener(v -> sendMessage());
    }
    ...
    private void checkForConversation(){
        if (chatMessages.size() != 0){
            checkForConversationRemotely(preferenceManager.getString(Constants.KEY_USERID), receiverUser.id);
            checkForConversationRemotely(receiverUser.id, preferenceManager.getString(Constants.KEY_USERID));
        }
    }
